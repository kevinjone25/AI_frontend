<template>
    <div class="flex text-white h-16 min-w-full fixed bg-neutral-900 bg-opacity-10 border-gray-800 border-b justify-center items-center backdrop-blur-lg z-10">
